        ...
        <div className=" w-[100%]  flex flex-col  h-full bg-[#1F2126] rounded-[2.5px] border-[1px] border-color ">
          ...
          <div className="h-[50%] w-[100%]   flex justify-center">
            <div className="w-[50%] h-[100%] overflow-auto tablecontainer  flex-col flex justify-start pl-6 pr-4 ">
              <p className="text-[#C2C1D2] text-[14px] font-Inter font-normal pt-4 flex items-start text-opacity-75 justify-start">
                General
              </p>
          ...
          <div className="h-[50%] w-[100%]   flex justify-center">
            <div className="w-[50%] h-[100%]  overflow-auto tablecontainer flex-col flex justify-start pl-6 pr-4 ">
              <p className="text-[#C2C1D2] text-[14px] font-Inter font-normal flex items-start text-opacity-75 justify-start">
                Settings
              </p>
