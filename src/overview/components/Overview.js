          ...
          <div className="graph flex p-[10px]">
            <div className="w-[60%]   h-[72vh]">
              <div className="w-[100%] h-[40%] flex justify-between">
                <div className="border w-[48%] border-color h-[100%]">
                  <p className="text-white mt-1">CPU</p>
                </div>
                <div className="border w-[48%] flex justify-center items-start border-color h-[100%]">
              ...
              <div className="line-graph mt-[10px] h-[58%] border border-color "></div>
            </div>
            <div className="w-[40%] ml-[10px]  h-[72vh]">
              <div className="h-[64%] border border-color w-[100%] ">
                <p className="mt-2 text-white">General</p>
                <div className=" flex items-center w-[100%]  justify-between py-3 px-4">
                  <div className="w-[49%] flex justify-start items-start flex-col pl-3  green pt-2">
                ...
                <div className=" flex items-center w-[100%] justify-between px-4">
                  <div className="w-[49%] flex justify-start items-start flex-col pl-3  red pt-2">
                ...
                <div className=" flex items-center w-[100%]  justify-between py-3 px-4">
                  <div className="w-[49%] border border-color rounded-[2.5px] flex justify-start items-start flex-col pl-3   pt-2">
                    <p className="text-[9px] text-white font-sanssem">USB</p>
                    <p className="text-[18px] text-white pb-2 font-sanssem">
                      Allow All
                    </p>
                  </div>
                  <div className="w-[49%] flex justify-start rounded-[2.5px] border border-color items-start flex-col pl-3  pt-2">
                    <p className="text-[9px] text-white font-sanssem">
                      Version
                    </p>
                    <p className="text-[18px]   text-white pb-2 font-sanssem">
              ...
              <div className=" h-[34%] overflow-auto tablecontainer mt-2.5 border border-color">
                ...
                <div className="flex items-center mx-8 justify-between">
                  <div className=" flex items-start justify-start flex-col">
                    <p className="mt-2  text-white ">Qurantine Files</p>
                    <p className="text-white text-opacity-75 text-[12px] ">
                      3 items
                    </p>
                  </div>
                  <Button className="rounded-[2.5px] cursor-pointer mb-[14px] mr-[18px] border border-white bg-[#2A2A2A] w-16  h-6 ">
                ...
                <div className="flex items-center mt-2 mx-8 justify-between">
                  <div className=" flex items-start justify-start flex-col">
                    <p className="mt-2  text-white ">Dynamic Sheilding</p>
                    <p className="text-white text-opacity-75 text-[12px] ">
                      0 items
                    </p>
                  </div>
                ...
                <div className="flex items-center my-2 mx-8 justify-between">
                  <div className=" flex items-start justify-start flex-col">
                    <p className="mt-2  text-white ">USB Connected </p>
                    <p className="text-white text-opacity-75 text-[12px] ">
                      0 items
                    </p>
                  </div>
