  ...
  return (
    <div className="w-[100%]">
      <div className="w-[100%] mt-7 pl-5 h-[61vh] overflow-auto  tablecontainer flex justify-start items-start flex-col">
        <p className="font-semibold font-Inter pl-5 leading-4 text-[14px] text-[#C2C1D2] ">
          Allow ALL
        </p>
        <p className="flex justify-center mt-3 mb-5  items-center text-white text-opacity-75 text-[12px] pl-5 leading-4 font-Inter">
          ...
          <div className="border-t  w-[100%] border-white border-opacity-[0.05]">
            <div className="w-[50%]  flex items-center">
              <div className="w-[10%] pl-5 flex justify-start flex-col items-start mt-6">
                <p className="text-[12px] font-Inter font-normal leading-4 text-[#C2C1D2] pb-5">
                  Vendor
                </p>
                <p className="text-[12px] font-Inter font-normal leading-4 text-[#C2C1D2] pb-5">
                  Sundisk
              ...
              <div className="w-[60%] pl-5 mt-6">
                <p className="text-[12px] font-Inter  font-medium leading-4 text-[#C2C1D2] pb-5">
                  Serial Number
                </p>
                <p className="text-[12px] font-Inter  font-medium leading-4 text-[#C2C1D2] pb-5">
