      ...
      <table className="w-[100%]  h-[63vh]   flex flex-col">
        ...
        <tbody className="w-[100%] h-[70%] ">
          {data.map((item, index) => (
            ...
            >
              <td className="text-[12px] flex justify-start w-[20%] font-Inter font-normal text-[#B9C0C9]">
                {item.ip}
              </td>
              <td className="text-[12px] leading-4 flex justify-start w-[30%] font-Inter font-normal text-[#B9C0C9]">
                {item.ports}
              </td>

              <td className="flex justify-end w-[50%]">
                <p className="text-[12px] leading-4 pr-2  font-Inter font-normal text-[#B9C0C9]">
                  {item.date}
                </p>
              </td>
            </tr>
