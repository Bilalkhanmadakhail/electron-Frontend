...
//       <div className="w-[35%] relative bg-[#020202] h-[88.5vh] border-b border-color rounded-br-[5px] border-r">
//         <div  className="absolute top-[5%] left-[88%] rounded-full bg-[#FF0000] w-[18px] h-[18px] flex items-center justify-center">
//           <img onClick={toggleSidebar} className="transform rotate-180" src={arrow} />
//         </div>
//         <div className="pt-20">
//           <div>
//             <ul>
//               <li className="group flex justify-start mb-4 cursor-pointer fill-none active:text-white active:fill-white active:bg-opacity-[0.10] hover:fill-[white] w-full items-center px-4 py-2 hover:bg-white hover:bg-opacity-[0.10] text-[#FFFFFF99] hover:text-white relative">
...
//                 </div>
//                 <div className="group-hover:block active:block absolute top-0 hidden right-0 h-full bg-white w-[3px]"></div>
//               </li>
//               <li>
//                 <div className=" hover:text-white hover:border-r-[3px] hover:border-white group flex justify-start mb-4 cursor-pointer  active:text-white active:fill-white active:bg-opacity-[0.10] hover:fill-[white] w-full items-center px-4 py-2 hover:bg-white hover:bg-opacity-[0.10] text-[#FFFFFF99]  relative  fill-[#FFFFFF99] ">
//                   <svg
//                     width="24"
//                     height="24"
//                     viewBox="0 0 19 16"
